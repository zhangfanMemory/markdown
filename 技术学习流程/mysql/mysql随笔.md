...
![红色的是undolog日志，所有的记录（红色绿色）称为版本链](pic/2023-07-24-15-42-25.png)

场景：
![](pic/2023-08-01-15-32-30.png)
...
1. 对于InnoDB存储引擎而言，只有在事务提交时才会记录binlog，此时记录还在内存中，那么binlog是什么时候刷到磁盘中的呢？
   1. 通过**sync_binlog**参数控制binlog的刷盘时机，取值范围是0-1-N
...
### 索引下推
索引下推 (Index Condition Pushdown，索引条件下推，简称 ICP)，是 MySQL5.6 版本的新特性
它可以在对联合索引遍历过程中，对索引中包含的所有字段先做判断，过滤掉不符合条件的记录之后再回表
![](pic/2023-11-06-15-34-41.png)


数据库锁：
![](pic/2024-03-15-10-41-56.png)
